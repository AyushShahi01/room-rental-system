...
class ExploreView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Assuming room functionality logic runs here
    // final RoomController roomCtrl = Get.find<RoomController>();
    
    // Quick local list for UI purposes
      ...
      child: Scaffold(
        ...
        body: CustomScrollView(
          slivers: [
            ...
            // Reusing the FeaturedPropertyCard logic if accessible.
            SliverPadding(
              padding: const EdgeInsets.symmetric(horizontal: 16),
              sliver: SliverList(
                delegate: SliverChildBuilderDelegate(
                  (context, index) {
                    // MOCK Property Model generation since we only have GetX controllers globally
                    // Using standard cards for the explore view layout
                    return Card(
