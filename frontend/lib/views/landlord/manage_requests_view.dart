...
class ManageRequestsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final MaintenanceController maintenanceCtrl =
                                    ...
                                    children: [
                                      Expanded(
                                        child: OutlinedButton(
                                          onPressed: () =>
                                              bookingCtrl.rejectRequest(req.id),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                                ...
                                Obx(() {
                                  return Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: req.status.value == 'Pending'
                            ...
                            Text(
                              "Tenant: ${req.tenantName} (${req.propertyTitle})",
                              style: const TextStyle(
                            ...
                            Obx(() {
                              if (req.status.value == 'Pending') {
                                return SizedBox(
                                  ...
                                  child: ElevatedButton(
                                    onPressed: () =>
                                        maintenanceCtrl.resolveRequest(req.id),
                                    style: ElevatedButton.styleFrom(
  ...
  Widget _buildStatusBadge(RxString status) {
    return Obx(() {
      Color c = status.value == 'Approved'
          ? Colors.green
          : (status.value == 'Rejected' ? Colors.red : Colors.orange);
      return Container(
